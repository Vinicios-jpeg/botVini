	...
	client.on('chat-update', async (mek) => {
		try {
			...
			switch(command) {
				...
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/FqoiMpz.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* MS PLAY\n*YOUTUBE:* https://www.youtube.com/msplay\n*Adaptado para VINI 1 UP:* *Canal:* https://www.youtube.com/channel/UC3Ngw5rt8C50X_IuBPS3D_g'})
					break
				case 'belle2':
					memein = await kagApi.memeindo()
				...
				case 'canal':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/FqoiMpz.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do VINI 1 UP:*\n\n https://www.youtube.com/channel/UC3Ngw5rt8C50X_IuBPS3D_g \n *CANAL DO MS PLAY:* https://www.youtube.com/msplay'})
					break
				case 'mia1':
					memein = await kagApi.memeindo()
